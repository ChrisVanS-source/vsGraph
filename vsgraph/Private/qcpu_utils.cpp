...
template class VSGRAPH_API _cpu_info<void>;

template<class T>
_cpu_info<T>::_cpu_info() {}
...
static cpu_utils_i cpu_information;

template<class T>
bool _cpu_info<T>::has_avx512()
{
    return cpu_information.HW_AVX512F;
}
